...
@section('content')
    <div style="display: flex; flex-direction: column; gap: 4rem">
        ...
        <div style="margin-bottom: 1rem"  class="flex items-baseline gap-4">
            <h3 class="text-3xl font-bold text-primary-clr font-title-fnt">Nome da vacina / Nome vaccino</h3>
            <h1 class="text-lg font-bold text-text-clr font-title-fnt">{!! $vaccination->name !!} ({!! $vaccination->id !!})</h1>
        </div>
    
        <div style="margin-bottom: 1rem" class="flex items-baseline gap-4">
            <h3 class="text-3xl font-bold text-primary-clr font-title-fnt">Data de vacinação / Data vaccinazione</h3>
            <h1 class="text-lg font-bold text-text-clr font-subtitle-fnt">{!! (new DateTime($vaccination->pivot->date))->format('d/m/Y') !!}</h1>
        </div>

        <div style="margin-bottom: 1rem" class="flex items-baseline gap-4">
            <h3 class="text-3xl font-bold text-primary-clr font-title-fnt">Data de recuperação / Data richiamo</h3>
